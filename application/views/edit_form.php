	...
	$('textarea.tinymce').tinymce({
			...
			style_formats : [
					...
					{title : 'User Input', inline : 'kbd', styles : {color : '#A70000'}},
               		{title : 'Table styles'},
					{title : 'Table Data', inline : 'kbd', styles : {color : '#A70000'}}
			]
		});
});
</script>
<div class="doc_create_form">
    ...
    echo form_open('edit', '', $hidden);
	echo '<div class="doc_select_container">';
	echo form_dropdown('ResourceArea', $resourceAreas, set_value('ResourceArea', $DocItem['ResourceAreaId']), 'class="doc_select", id="ResourceArea"');
	echo '</div>';
    ...
    $data = array(
        'name'        => 'DocItem',
        'id'          => 'DocItem',
        'value'       => set_value('DocItem', $DocItem['DocItem']),
        'class'		=> 'doc_input',
    ...
    $data = array(
        'name'        => 'DocItemContent',
        'id'          => 'DocItemContent',
        'value'       => set_value('DocItemContent', $DocItem['DocItemContent']),
        'class'		=> 'doc_text tinymce',
		'placeholder' => 'Enter Documentation Here...'
        );
    echo form_textarea($data);
	
	echo '<a href="javascript:void(0);" class="doc_update_btn" id="UpdateDocBtn"></a>';
